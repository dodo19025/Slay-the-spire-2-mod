...
public class IsItYou() : TheMiddleNurseFatherOutisCard(
    ...
    TargetType.AnyEnemy)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => (new DynamicVar[4]
    {
        ...
        new DynamicVar("BleedNextAttack",1m),
        new DynamicVar("BleedPowerAmount",1m)
    });
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<BleedNextAttackPower>(choiceContext,base.Owner.Creature,base.DynamicVars["BleedNextAttack"].BaseValue,base.Owner.Creature, this);
    }
